 ...
 * @date 2025-01-20
 */
public interface MissileTrajectoryMapper {
    ...
    public List<MissileTrajectoryVo> selectMissileTrajectoryAll();
     ...
     * @return 结果
     */
    public int insertMissileTrajectoryBatch(@Param("list") List<MissileTrajectoryVo> list);
    ...
    public int deleteMissileTrajectoryByFlag(int flag);
