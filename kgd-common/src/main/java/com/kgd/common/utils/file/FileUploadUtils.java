...
import com.kgd.common.exception.file.FileNameLengthLimitExceededException;
import com.kgd.common.exception.file.FileSizeLimitExceededException;
import com.kgd.common.exception.file.InvalidExtensionException;
import com.kgd.common.utils.DateUtils;
import com.kgd.common.utils.StringUtils;
import com.kgd.common.utils.uuid.IdUtils;
import com.kgd.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = KgdConfig.getProfile();
    ...
    {
        int dirLastIndex = KgdConfig.getProfile().length() + 1;
